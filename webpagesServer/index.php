    ...
    <script type="text/javascript" src="jQuery.js"></script>
        <script type="text/javascript">
            ...
            <section class="center" id="buttons">
                ...
                <div id="controls" class="align-items:center;" align="center">
                  ...
                  <tr><td></td><td align="center"><button class="button button2" id="forward" >FORWARD</button></td><td></td><td align="left"><p align = "left">
          <i class="fas fa-lightbulb" style="color:#059e8a;"></i> 
          <span class="dht-labels">Energy</span> 
          <span id="energyvalue">%ENERGY%</span>
        </p></td></tr>
                  <tr><td align="center"><button class="button button2" id="turnleft" >LEFT</button></td><td align="center"></td><td align="center"><button class="button button2" id="turnright" >RIGHT</button></td><td align="left">     
        <p align = "left">
          ...
          <span id="positionvalue">%POSITION%</span>
                  ...
                  <tr><td></td><td align="center"><button class="button button2" id="backward" >REVERSE</button></td><td></td><td align="left"><p align = "left">
